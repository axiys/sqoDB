...
#endif
        internal void ReadObjectRow(sqoDB.Utilities.ObjectRow row, SqoTypeInfo ti, int oid, RawdataSerializer rawSerializer)
        {
...
#if ASYNC
        internal async Task ReadObjectRowAsync(sqoDB.Utilities.ObjectRow row, SqoTypeInfo ti, int oid, RawdataSerializer rawSerializer)
        {
