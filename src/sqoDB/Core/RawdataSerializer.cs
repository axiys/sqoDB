    ...
    class RawdataSerializer
    {
        ...
        private ArrayInfo SerializeArray(object obj, Type objectType, ObjectSerializer objSerializer,int dbVersion,bool elementIsText)
        {
            ...
            else
            {
                ...
                foreach (object elem in ((IList)obj))
                {
                    ...
                    {
                        throw new sqoDB.Exceptions.NotSupportedTypeException("IDictionary it is not supported type as IList element type.");
                    }
                    else
                    {
                        object elemObj = elem;
        ...
        public byte[] SerializeDictionary(object obj, int length, int dbVersion, DictionaryInfo dictInfo,ObjectSerializer objSerializer)
        {
            ...
            foreach (object elem in dictionary.Keys)
            {
                ...
                {
                    throw new sqoDB.Exceptions.NotSupportedTypeException("Array/IList as Type of Key of a Dictionary it is not supported");
                }
                else
                {
                ...
                {
                    throw new sqoDB.Exceptions.NotSupportedTypeException("Array/IList as Type of Value of a Dictionary it is not supported");
                }
                else
                {
