...
namespace sqoDB.Internal
{
        ...
        static class _bs
    {
        ...
        ///     Do NOT use it!, it is used only internally
        /// </summary>
        public static void _loidtid(Siaqodb siaqodb, int oid, MetaType metaType, string fieldName,
            ref List<int> listOIDs, ref int TID)
        {
        ...
        ///     Do NOT use it!, it is used only internally
        /// </summary>
        public static void _ltid(Siaqodb siaqodb, int oid, MetaType metaType, string fieldName, ref int TID,
            ref bool isArray)
        {
