...
namespace sqoDB
{
    ...
    {
        sqoDB.Transactions.ITransaction BeginTransaction();
        ISqoQuery<T> Cast<T>();
        void Close();
        int Count<T>();
        void Delete(object obj);
        void Delete(object obj, sqoDB.Transactions.ITransaction transaction);
        event EventHandler<DeletedEventsArgs> DeletedObject;
        bool DeleteObjectBy(object obj, params string[] fieldNames);
        bool DeleteObjectBy(object obj, sqoDB.Transactions.ITransaction transaction, params string[] fieldNames);
        ...
        void StoreObject(object obj, sqoDB.Transactions.ITransaction transaction);
        ...
        bool UpdateObjectBy(object obj, sqoDB.Transactions.ITransaction transaction, params string[] fieldNames);
        ...
        System.Threading.Tasks.Task DeleteAsync(object obj, sqoDB.Transactions.ITransaction transaction);
        System.Threading.Tasks.Task<bool> DeleteObjectByAsync(object obj, params string[] fieldNames);
        System.Threading.Tasks.Task<bool> DeleteObjectByAsync(object obj, sqoDB.Transactions.ITransaction transaction, params string[] fieldNames);
        ...
        System.Threading.Tasks.Task StoreObjectAsync(object obj, sqoDB.Transactions.ITransaction transaction);
        ...
        System.Threading.Tasks.Task<bool> UpdateObjectByAsync(object obj, sqoDB.Transactions.ITransaction transaction, params string[] fieldNames);
