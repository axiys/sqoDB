...
namespace sqoDB
{
    public class Configurator
    {
        ...
        /// <summary>
        /// Add an UniqueConstraint for a field of a certain Type,an UniqueConstraint can be added also by using Attribute: sqoDB.Attributes.UniqueConstraint;
        ...
        /// <summary>
        /// Put MaxLength for a string field or automatic property of a Type, MaxLength can be set also by using Attribute: sqoDB.Attributes.MaxLength
        /// </summary>
        /// <param name="field">Field name or automatic property name</param>
        ...
        /// <summary>
        /// Mark a field or automatic property of a certain Type to be serialized as a Document ,it can be added also by using Attribute: sqoDB.Attributes.Document;
        ...
        /// <summary>
        /// Set the name of backing field for a property in case engine cannto discover it, this also can be set by attribute: sqoDB.Attributes.UseVariable
        /// </summary>
