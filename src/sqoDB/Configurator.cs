...
namespace sqoDB
{
    public class Configurator
    {
        ...
        internal bool encryptedDatabase;
        ...
        public bool EncryptedDatabase
        {
            ...
            set => encryptedDatabase = value;
        }

        public bool BuildIndexesAsync { get; set; }

        public TraceListener LoggingMethod { get; set; }

        public VerboseLevel VerboseLevel { get; set; }

        public decimal BufferingChunkPercent { get; set; }
        ...
        {
            if (DatabaseFileNames == null) DatabaseFileNames = new Dictionary<Type, string>();
            if (!DatabaseFileNames.ContainsKey(type)) DatabaseFileNames.Add(type, fileName);
        }
        ...
        public void LoadRelatedObjects(Type type, bool loadRelatedObjects)
        {
            ...
            OnLoadRelatedObjectsPropetyChanged(EventArgs.Empty);
        }
        ...
        {
            if (LoadRelatedObjectsPropetyChanged != null) LoadRelatedObjectsPropetyChanged(this, e);
        }
