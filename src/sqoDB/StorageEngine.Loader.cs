...
#if UNITY3D
            Dictionary<int, object> outerDict = new Dictionary<int, object>(new sqoDB.Utilities.EqualityComparer<int>());
			Dictionary<int, object> innerDict = new Dictionary<int, object>(new sqoDB.Utilities.EqualityComparer<int>());
#else
