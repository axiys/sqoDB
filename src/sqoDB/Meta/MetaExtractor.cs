...
namespace sqoDB.Meta
{
	class MetaExtractor
	{
        ...
        public static ObjectInfo GetObjectInfo(object o, SqoTypeInfo ti, sqoDB.Cache.MetaCache metaCache)
        {
            ...
            foreach (FieldSqoInfo attKey in ti.Fields)
            {
                ...
                {
                    sqoDB.MetaObjects.DocumentInfo dinfo = new sqoDB.MetaObjects.DocumentInfo();
